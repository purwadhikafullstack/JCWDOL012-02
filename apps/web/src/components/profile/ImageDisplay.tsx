...
export default function ImageDisplay(props: ImageDisplayProps) {
  ...
  return (
    <div className="col-span-1 w-full flex sm:flex-col flex-row sm:space-x-0 space-x-4 items-center">
      ...
      <div className="flex w-full flex-col justify-end my-2 px-2 space-y-2">
        <div>
